...
abstract contract AegylaxStorage {
    ...
    struct GameStorage {
        ...
        /// attackId => the plaintext one-time pad, once `revealEpochAttack` has published it.
        mapping(bytes32 => uint256) publishedMaskKeys;
        mapping(bytes32 => bool) maskPublished;
    }
